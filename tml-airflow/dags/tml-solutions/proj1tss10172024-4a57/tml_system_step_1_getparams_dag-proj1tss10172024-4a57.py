...
default_args = {
 ...
 'solutionname': 'proj1tss10172024-4a57',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_proj1tss10172024-4a57", default_args=default_args, tags=["tml_system_step_1_getparams_dag_proj1tss10172024-4a57"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
